...
export default function  EmpProfilePage({ isOpen, onClose, onEmpProfilePage }) {
  ...
  const handleSaveConfirmed = () => {
    onEmpProfilePage(profileDetails);
    onClose();
             ...
             <Card sx={{display: 'flex', alignItems: 'center', width: 280, height: 140, border: '1px solid #B3B3B3', borderRadius: '5px' }}>
               <CardContent>
                ...
                <select
                  ...
                  id="officemode"
                  name="officemode"
                  value={profileDetails.officemode}
                  placeholder="Select"
                  onChange={(e) => setProfileDetails({ ...profileDetails, officemode: e.target.value })}
                  style={{ width: '100px' ,  margin: '5px', outline: 'none', height: '25px', border: '1px solid #B3B3B3', borderRadius: '10px', padding: '2px' }}
                >
