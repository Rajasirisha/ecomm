...
export default function Addemp({ open, onClose, onAddEmp }) {
    ...
    const [empDetails, setEmpDetails] = useState({
      ...
      const handleSubmit = (e) => {
        e.preventDefault();
        console.log("Employee details submitted: ", empDetails);
        onClose(); 
      };
      ...
      const handleCancelImage = () => {
        setEmpDetails({ ...empDetails, image: '' });
      };
  ...
  return (
    <Dialog open={open} onClose={onClose} sx={{ '& .MuiDialog-paper': { width: '950px', height: '950px', borderRadius: '20px' } }}>
      ...
      <DialogContent sx={{ fontSize: '12px', fontStyle: 'semibold', fontFamily: 'Poppins' }}>
        ...
        <Grid item xs={4}>
        <Card sx={{display: 'flex', alignItems: 'center', width: '140px', height: 180, border: '1px solid #B3B3B3', borderRadius: '5px',}}>
        <CardContent>
                <div
                  style={{
                    position: 'relative',
                ...
                >
                    ...
                    <img
                      src={empDetails.image || 'placeholder.png'}
                      alt=""
            ...
            <Grid item xs={11}>
        <Card sx={{ width: '100%', height: 180, border: '1px solid #B3B3B3', borderRadius: '5px', display: 'flex', alignItems: 'center', justifyContent: 'space-between'}}>
        <CardContent >
        <Grid item >
            <div>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setEmpDetails({ ...empDetails, role: e.target.value })}
                  style={{ width: '100px' ,  margin: '5px', outline: 'none', height: '25px', border: '1px solid #B3B3B3', borderRadius: '10px', padding: '2px' }}
                />
                </div>
                </div>
                ...
                <input
                  ...
                  onChange={(e) => setEmpDetails({ ...empDetails, phone: e.target.value })}
                  style={{ width: '100px' ,  margin: '5px', outline: 'none', height: '25px', border: '1px solid #B3B3B3', borderRadius: '10px', padding: '2px' }}
                />
                </div> 
                </div>
            ...
            <Grid item xs={6}>
             <Card sx={{display: 'flex', alignItems: 'center', width: 280, height: 140, border: '1px solid #B3B3B3', borderRadius: '5px' }}>
               <CardContent>
                <div>
                ...
                <input
                  ...
                  id="onboarding"
                  name="onboarding"
                  value={empDetails.onboarding}
                  onChange={(e) => setEmpDetails({ ...empDetails, onboarding: e.target.value })}
                  style={{ width: '100px' ,  margin: '5px', outline: 'none', height: '25px', border: '1px solid #B3B3B3', borderRadius: '10px', padding: '2px' }}
                />
                </div>
                <div>
                ...
                <input
                  ...
                  id="worked"
                  name="worked"
                  value={empDetails.worked}
                  placeholder=" Years, Months"
                  onChange={(e) => setEmpDetails({ ...empDetails, worked: e.target.value })}
                  style={{ width: '100px' ,  margin: '5px', outline: 'none', height: '25px', border: '1px solid #B3B3B3', borderRadius: '10px', padding: '2px' }}
                />
                </div>
                <div>
                <label htmlFor="officemode">Office Mode :</label>
                <select
                  type="select"
                  id="officemode"
                  name="officemode"
                  value={empDetails.officemode}
                  placeholder="Select"
                  onChange={(e) => setEmpDetails({ ...empDetails, officemode: e.target.value })}
                  style={{ width: '100px' ,  margin: '5px', outline: 'none', height: '25px', border: '1px solid #B3B3B3', borderRadius: '10px', padding: '2px' }}
                >
            ...
            <Grid item xs={8}>
             <Card sx={{ width: 250, height: 305, border: '1px solid #B3B3B3', borderRadius: '5px',  overflow: 'auto' }}>
               <CardContent>
                <div>
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between',}}>
        ...
        sx={{color: '#fff', backgroundColor: '#173767', height: '30px',
          ...
          '&:hover': {
           backgroundColor: '#173767',
           color: '#E2A925',
           }, }} onClick={handleAddEmp}>Add Employee</Button>
        <Button variant='filled' 
