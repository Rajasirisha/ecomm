...
function createData(sno, date, code, taskName, dailyActivity, wordCount, status) {
  return { sno, date, code, taskName, dailyActivity, wordCount, status };
}

const rows = [
  createData(1, '01-01-2023', 'ABC123', 'Example Task', 'Writing', 500, 'Completed'),
  createData(2, '01-01-2023', 'ABC123', 'Example Task', 'Writing', 500, 'Completed'),
  createData(3, '01-01-2023', 'ABC123', 'Example Task', 'Writing', 500, 'Completed'),
];
